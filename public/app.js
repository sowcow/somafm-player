        ...
        if (defaults.constructor === Object) {
          ...
          for (var key in defaults) {
            ...
            if (value && value.constructor === Object) {
              map[key] = $scope.get('Hash').$new(value);
            }
            else {
...
Opal.modules["opal-jquery/element"] = function($opal) {
  ...
  $opal.add_stubs(['$require', '$include', '$attr_reader', '$expose', '$alias_native', '$[]=', '$nil?', '$is_a?', '$to_n', '$has_key?', '$delete', '$call', '$gsub', '$upcase', '$[]', '$compact', '$map', '$respond_to?', '$<<', '$Native', '$new']);
  self.$require("native");
...
Opal.modules["opal-jquery/http"] = function($opal) {
  ...
  $opal.add_stubs(['$require', '$attr_reader', '$send!', '$new', '$delete', '$to_n', '$from_object', '$succeed', '$fail', '$call', '$parse', '$xhr']);
  self.$require("json");
  self.$require("native");
  return (function($base, $super) {
    function $HTTP(){};
...
Opal.modules["player"] = function($opal) {
  ...
  $opal.add_stubs(['$require', '$new', '$Native', '$puts', '$play_url', '$channel_url', '$private', '$+', '$src=', '$play', '$find', '$raise']);
  self.$require("native");
  return (function($base, $super) {
    function $ThePlayer(){};
    ...
    def.$initialize = function() {
      ...
      self.player = $scope.get('Element').$new("audio");
    ...
    def.$play_url = function(url) {
      ...
      url = url['$+']("/;");
      (($a = [url]), $b = self.player, $b['$src='].apply($b, $a), $a[$a.length-1]);
    ...
    return (def.$channel_url = function(channel) {
      ...
      ((($a = found = ($b = ($c = (Channels)).$find, $b.$$p = (TMP_1 = function(x){var self = TMP_1.$$s || this;
if (x == null) x = nil;
      return x.id === channel;}, TMP_1.$$s = self, TMP_1), $b).call($c)) !== false && $a !== nil) ? $a : self.$raise());
...
(function($opal) {
  ...
  $opal.add_stubs(['$require', '$ready?', '$new', '$find', '$on', '$attr', '$current_target', '$play']);
  self.$require("opal");
  self.$require("jquery");
  self.$require("opal-jquery");
  self.$require("player");
  return ($a = ($b = $scope.get('Document'))['$ready?'], $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $a, $b, TMP_2, channels = nil;

  $opal.cdecl($scope, 'Player', $scope.get('ThePlayer').$new());
    channels = $scope.get('Element').$find(".channel");
    return ($a = ($b = channels).$on, $a.$$p = (TMP_2 = function(e){var self = TMP_2.$$s || this, channel = nil;
if (e == null) e = nil;
    channel = e.$current_target().$attr("x-id");
      return $scope.get('Player').$play(channel);}, TMP_2.$$s = self, TMP_2), $a).call($b, "click");}, TMP_1.$$s = self, TMP_1), $a).call($b);
})(Opal);
